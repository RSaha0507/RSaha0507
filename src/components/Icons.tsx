...
export const PythonIcon: React.FC<{ className?: string }> = ({ className = 'w-4 h-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M11.91 2c-5.04 0-4.72 2.18-4.72 2.18l.01 2.26h4.79v.68H5.27S2 6.74 2 11.8s2.86 4.9 2.86 4.9h1.71v-2.41s-.09-2.86 2.81-2.86h4.82s2.68.04 2.68-2.61V5.04s.39-3.04-5.03-3.04zM9.54 3.73a.85.85 0 1 1 0 1.7.85.85 0 0 1 0-1.7zm2.55 18.27c5.04 0 4.72-2.18 4.72-2.18l-.01-2.26h-4.79v-.68h6.72s3.27.38 3.27-4.68-2.86-4.9-2.86-4.9h-1.71v2.41s.09 2.86-2.81 2.86H9.71s-2.68-.04-2.68 2.61v3.78s-.39 3.04 5.06 3.04zm2.37-1.73a.85.85 0 1 1 0-1.7.85.85 0 0 1 0 1.7z" />
  </svg>
);
...
export const PyTorchIcon: React.FC<{ className?: string }> = ({ className = 'w-4 h-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2L6 8l6 6 6-6-6-6z" fill="currentColor" fillOpacity="0.3" />
...
export const DatabaseIcon: React.FC<{ className?: string }> = ({ className = 'w-4 h-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SparklesTechIcon: React.FC<{ className?: string }> = ({ className = 'w-4 h-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const LayersIcon: React.FC<{ className?: string }> = ({ className = 'w-4 h-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
